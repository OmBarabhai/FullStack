...
Instead of visiting every index (idx + 1),

recursion jumps directly to

idx + K  or  idx - K,
---

allowing alternate traversal, every Kth traversal, and optimized recursive processing.
---
|  # | Problem                  | Platform | Difficulty | Interview | Status | R1 | R2 | R3 | R4 | R5 | Notes                 |
|---:|--------------------------|----------|------------|-----------|:------:|:--:|:--:|:--:|:--:|:--:|-----------------------|
| 51 | Print Even Index         | Custom   | 🟢         | ⭐⭐⭐       |   ✅    | ✅  | ✅  | ✅  | ⬜  | ⬜  | Start = 0, Jump = 2   |
| 52 | Print Odd Index          | Custom   | 🟢         | ⭐⭐⭐       |   ✅    | ✅  | ✅  | ✅  | ⬜  | ⬜  | Start = 1, Jump = 2   |
| 53 | Print Even Index Reverse | Custom   | 🟢         | ⭐⭐⭐       |   ✅    | ✅  | ✅  | ✅  | ⬜  | ⬜  | Reverse Jump          |
| 54 | Print Odd Index Reverse  | Custom   | 🟢         | ⭐⭐⭐       |   ✅    | ✅  | ✅  | ✅  | ⬜  | ⬜  | Reverse Jump          |
| 55 | Sum Even Index           | Custom   | 🟢         | ⭐⭐⭐       |   ✅    | ✅  | ✅  | ✅  | ⬜  | ⬜  | Contribution + Jump   |
| 56 | Sum Odd Index            | Custom   | 🟢         | ⭐⭐⭐       |   ✅    | ✅  | ✅  | ✅  | ⬜  | ⬜  | Contribution + Jump   |
| 57 | Print Every Kth Element  | Custom   | 🟡         | ⭐⭐⭐⭐      |   ✅    | ✅  | ✅  | ✅  | ⬜  | ⬜  | Generalized `idx + K` |
| 58 | Sum Every Kth Element    | Custom   | 🟡         | ⭐⭐⭐⭐      |   ✅    | ✅  | ✅  | ✅  | ⬜  | ⬜  | Generalized `idx + K` |
