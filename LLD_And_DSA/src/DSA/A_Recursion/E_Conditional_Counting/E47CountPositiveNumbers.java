...
public class E47CountPositiveNumbers {
     ...
     *
     * Faith:
     * countPositiveNumbers(arr, idx + 1)
    ...
    public static int countPositiveNumbersDirect(int[] arr, int idx) {
        ...
        // Current Work
        if (arr[idx] > 0) {
            return 1 + countPositiveNumbersDirect(arr, idx + 1);
        }

        // Recursive Call
        return countPositiveNumbersDirect(arr, idx + 1);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Positive Numbers : "
                + countPositiveNumbersDirect(arr, 0));
    }
}
