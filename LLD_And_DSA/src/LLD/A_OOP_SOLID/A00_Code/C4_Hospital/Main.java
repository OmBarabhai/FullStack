...
public class Main {
    ...
    public static void main(String[] args) {
        Patient p0 = new Patient();//this is default constructor if we create object without their details it should be automatically initialize or we can create without parameters in patient class
