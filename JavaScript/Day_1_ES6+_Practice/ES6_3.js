...
// const formatArray = (array) => array;

// const items = ["apple", "banana", "orange"];
// const message_1 = formatArray(items);
// console.log("\n" + message_1); // The array has 3 items, and the first item is "apple", and the last item is "orange".
...
//   `\n${name} costs INR ${price} and is in stock.\n`;
// const product = {
//   name: "Socks",
//   price: 249,
//   inStock: true,
// };
// const message_2 = formatProduct(product);
...
//   ),
// );
// //mistake  3. Write a function findPerson that takes an array of person objects and a name as parameters and returns the object with the matching name, or null if not found.
// const findPerson = ([{...person}], personName) => (personName == name) ? `${person.name}` : null;
...
// const printFirstCharacter = (array) => array[0];
...
//   city: "Germany",
// };
// console.log(getAddress(userData)); // {postalCode: '12134', city: 'Germany'}
...
// const printProductDetails =({name,specification})=>`${name} is of ${specification.size}`
// const product = {
